...
export default function DeleteProjectManagerModal({
  manager,
  onClose,
  onSaved,
}: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div className="relative w-full sm:max-w-md bg-white dark:bg-zinc-900 sm:rounded-2xl rounded-t-2xl border border-zinc-200 dark:border-zinc-800 shadow-2xl flex flex-col overflow-hidden">
        <BottomSheetHandle />
        ...
        <div className="px-6 py-5 flex flex-col gap-3">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Yakin ingin menghapus project manager berikut?
          </p>
