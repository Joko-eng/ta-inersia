  ...
  return (
    <div className="flex flex-col h-full min-h-0 gap-4">
      <div className="flex items-center justify-between gap-3 shrink-0">
        ...
        <div className="h-9 w-44 bg-zinc-300 dark:bg-zinc-700 rounded-lg animate-pulse" />
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-zinc-100 dark:border-zinc-800 bg-[#F5F5F3] dark:bg-zinc-800/80">
                {["No", "Nama", "Email", "Username", "Dibuat", "Aksi"].map((col) => (
                  <th
                    key={col}
      ...
      <div className="lg:hidden flex-1 min-h-0 flex flex-col gap-3 overflow-y-auto p-3">
