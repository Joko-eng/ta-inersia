  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span
          className={`text-[9px] text-zinc-300 dark:text-zinc-600 transition-transform duration-150 ${open ? "rotate-180" : ""}`}
        >
          ▼
        </span>
      </button>
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col gap-1 min-w-0">
          ...
          {item.mapsUrl ? (
            ...
            <span className="text-[14px] font-semibold text-zinc-900 dark:text-white leading-snug">
              {item.nama}
            </span>
          )}
        </div>
...
>>>>>>> 6885a46 (update 2 mei componen compro)
  ...
  const paginated = initialLeads.slice(
                ...
                paginated.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-[12px] font-mono text-zinc-500 dark:text-zinc-500 tracking-tight">
                      {item.noTelp || (
                        <span className="text-zinc-200 dark:text-zinc-800 font-sans">
                          -
                        </span>
                      )}
                    </td>
