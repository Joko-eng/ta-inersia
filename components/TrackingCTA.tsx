...
export default function TrackingCTA() {
  ...
  return (
    <section
      id="monitoring"
      className="relative overflow-hidden py-8 bg-primary/5 dark:bg-primary scroll-mt-20"
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(#000_1px,transparent_1px)] dark:bg-[radial-gradient(#fff_1px,transparent_1px)] bg-[size:24px_24px] opacity-[0.08]"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-300 text-[15px] leading-relaxed max-w-md mx-auto mb-10">
          {t("tracking.desc")}
        </p>
        ...
        >
          {t("tracking.btn")}
          <span
            className="w-7 h-7 bg-white/20 dark:bg-primary/10 rounded-lg flex items-center justify-center"
            aria-hidden="true"
          >
        ...
        >
          {[
            ...
            >
              <span
                className="w-1.5 h-1.5 rounded-full bg-primary/60 dark:bg-white/60 shrink-0"
                aria-hidden="true"
              />
              {f}
            </div>
